...
urlpatterns = [
    ...
    path('create-review/', store_views.CreateReviewAPIView.as_view(), name='create_review'),
    path('reviews/<product_id>/', store_views.ReviewListAPIView.as_view(), name='reviews_list'),
